...
<head>
    ...
    <!-- CSS
        ================================================== -->
    <!-- Bootstrap 3-->
    <link href="${sourceUrl}/landy/css/bootstrap.min.css" rel="stylesheet" media="screen">
    <!-- Google Fonts -->
    ...
    <!-- Template Styles -->
    <link href="${sourceUrl}/landy/css/style.css" rel="stylesheet" media="screen">
...
<body>
                        ...
                        <div id="carousel-example-generic" class="carousel slide">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="${sourceUrl}/landy/img/screenshots/app-1.png" alt="App Screen 1">
                                </div>
                                <div class="item">
                                    <img src="${sourceUrl}/landy/img/screenshots/app-2.png" alt="App Screen 2">
                                </div>
                                <div class="item">
                                    <img src="${sourceUrl}/landy/img/screenshots/app-3.png" alt="App Screen 3">
                                </div>
                        ...
                        <div class="carousel-inner">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-5">
                                        <div class="app-screenshot">
                                            <img src="${sourceUrl}/landy/img/screenshots/app-1.png" class="img-responsive" alt="App Screen 1">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-5">
                                        <div class="app-screenshot">
                                            <img src="${sourceUrl}/landy/img/screenshots/app-2.png" class="img-responsive" alt="App Screen 2">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-5">
                                        <div class="app-screenshot">
                                            <img src="${sourceUrl}/landy/img/screenshots/app-3.png" class="img-responsive" alt="App Screen 3">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- JAVASCRIPT
            ================================================== -->
    <script src="${sourceUrl}/landy/js/jquery.js"></script>
    <script src="${sourceUrl}/landy/js/bootstrap.min.js"></script>
    <script src="${sourceUrl}/landy/js/animatescroll.js"></script>
    <script src="${sourceUrl}/landy/js/scripts.js"></script>
    <script src="${sourceUrl}/landy/js/retina.min.js"></script>
</body>
</html>