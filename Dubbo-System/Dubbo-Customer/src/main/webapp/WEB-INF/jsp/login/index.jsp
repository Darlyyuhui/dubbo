...
<head>
    ...
    <meta content="展示新样式" name="description"/>
    <meta content="张宇辉" name="author"/>
    <!-- 上述3个meta标签*必须*放在最前面，任何其他内容都*必须*跟随其后！ -->
    <title>${itmsname}</title>
    <!-- GLOBAL MANDATORY STYLES -->
    <link href="http://fonts.googleapis.com/css?family=Hind:300,400,500,600,700" rel="stylesheet" type="text/css">
    <link href="${sourceUrl}/module/2520/vendor/simple-line-icons/css/simple-line-icons.css" rel="stylesheet" type="text/css"/>
    <link href="${sourceUrl}/module/2520/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    <!-- PAGE LEVEL PLUGIN STYLES -->
    <link href="${sourceUrl}/module/2520/css/animate.css" rel="stylesheet">
    <!-- THEME STYLES -->
    <link href="${sourceUrl}/module/2520/css/layout.min.css" rel="stylesheet" type="text/css"/>
</head>
            ...
            <div class="menu-container js_nav-item">
                ...
                <div class="logo">
                    <a class="logo-wrap" href="#body">
                        <img class="logo-img logo-img-main" src="${sourceUrl}/module/2520/img/logo.png" alt="Asentus Logo">
                        <img class="logo-img logo-img-active" src="${sourceUrl}/module/2520/img/logo-dark.png" alt="Asentus Logo">
                    </a>
                </div>
                <!-- End Logo -->
            </div>
...
<!--========== SLIDER ==========-->
<div class="promo-block parallax-window" data-parallax="scroll" data-image-src="${sourceUrl}/module/2520/img/1920x1080/01.jpg">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-8 col-sm-offset-1">
                ...
                <div class="masonry-grid row row-space-2">
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-8 margin-b-4">
                        ...
                        <div class="work work-popup-trigger">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="${sourceUrl}/module/2520/img/800x400/01.jpg" alt="Portfolio Image">
                            </div>
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 margin-b-4">
                        ...
                        <div class="work work-popup-trigger">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="${sourceUrl}/module/2520/img/397x400/01.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-popup-overlay">
                                <div class="work-popup-content">
                                    <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 md-margin-b-4">
                        ...
                        <div class="work work-popup-trigger">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="${sourceUrl}/module/2520/img/397x300/01.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-popup-overlay">
                                <div class="work-popup-content">
                                    <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4 md-margin-b-4">
                        ...
                        <div class="work work-popup-trigger">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="${sourceUrl}/module/2520/img/397x300/02.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-popup-overlay">
                                <div class="work-popup-content">
                                    <a href="javascript:void(0);" class="work-popup-close">Hide</a>
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-4">
                        ...
                        <div class="work work-popup-trigger">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="${sourceUrl}/module/2520/img/397x300/03.jpg" alt="Portfolio Image">
                            </div>
                            <div class="work-popup-overlay">
                                <div class="work-popup-content">
                                    <a href="javascript:void(0);" class="work-popup-close">Hide</a>
...
<footer class="footer">
    <div class="content container">
        <div class="row">
            <div class="col-xs-6">
                <img class="footer-logo" src="${sourceUrl}/module/2520/img/logo-dark.png" alt="Aircv Logo">
            </div>
            <div class="col-xs-6 text-right sm-text-left">
                <p class="margin-b-0">Copyright &copy; 2017.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
            </div>
        </div>
        <!--// end row -->
    </div>
...
<!-- CORE PLUGINS -->
<script src="${sourceUrl}/module/2520/vendor/jquery.min.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/vendor/jquery-migrate.min.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/vendor/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>

<!-- PAGE LEVEL PLUGINS -->
<script src="${sourceUrl}/module/2520/vendor/jquery.easing.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/vendor/jquery.back-to-top.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/vendor/jquery.smooth-scroll.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/vendor/jquery.wow.min.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/vendor/jquery.parallax.min.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/vendor/jquery.appear.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/vendor/masonry/jquery.masonry.pkgd.min.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/vendor/masonry/imagesloaded.pkgd.min.js" type="text/javascript"></script>

<!-- PAGE LEVEL SCRIPTS -->
<script src="${sourceUrl}/module/2520/js/layout.min.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/js/components/progress-bar.min.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/js/components/masonry.min.js" type="text/javascript"></script>
<script src="${sourceUrl}/module/2520/js/components/wow.min.js" type="text/javascript"></script>
