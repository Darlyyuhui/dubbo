                            ...
                            <div class="card-body">
                                <table class="datatable table table-striped" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center">活动策划负责人</th>
                                        <th style="text-align: center">活动创建时间</th>
                                        <th style="text-align: center">活动修改时间</th>
                                        <th style="text-align: center">活动修改说明</th>
                                        <th style="text-align: center">活动图标</th>
                                    </tr>
                                    </thead>
                                    <tfoot>
                                    <tr>
                                    ...
                                    <c:forEach items="${STORETYPE}" var="item">
                                        <tr>
                                            ...
                                            <td>${item.storeStartTime}</td>
                                            <td>${item.storeEndTime}</td>
                                            <td>${item.storeTypeOp}</td>
                                            <td>${item.storeCreatetime}</td>
                                            <td>${item.storeUpdatetime}</td>
                                            <td>${item.storeUpdatereason}</td>
                                            <td>${item.storeTypeIcon}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
