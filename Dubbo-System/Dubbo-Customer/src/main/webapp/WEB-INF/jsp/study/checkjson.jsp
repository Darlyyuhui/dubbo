...
<head>
    ...
    <link href="${resourceUrl}/basejs/json/css/font-awesome.min.css" rel="stylesheet">
    <link href="${resourceUrl}/basejs/json/css/base.css" rel="stylesheet">
...
<link href="${resourceUrl}/basejs/json/css/jquery.numberedtextarea.css" rel="stylesheet">
<script src="${resourceUrl}/basejs/json/js/hm.js"></script>
<script src="${resourceUrl}/basejs/json/jq/jquery.min.js"></script>
<script src="${resourceUrl}/basejs/json/jq/jquery.message.js"></script>
<script src="${resourceUrl}/basejs/json/jq/jquery.json.js"></script>
<script src="${resourceUrl}/basejs/json/jq/jquery.xml2json.js"></script>
<script src="${resourceUrl}/basejs/json/jq/jquery.json2xml.js"></script>
<script src="${resourceUrl}/basejs/json/js/json2.js"></script>
<script src="${resourceUrl}/basejs/json/js/jsonlint.js"></script>
<script src="${resourceUrl}/basejs/json/js/clipboard.min.js"></script>
<script src="${resourceUrl}/basejs/json/js/FileSaver.min.js"></script>
<script src="${resourceUrl}/basejs/json/jq/jquery.numberedtextarea.js"></script>
