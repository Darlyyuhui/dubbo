...
<head>
    ...
    <link href="${root}/basejs/json/css/font-awesome.min.css" rel="stylesheet">
    <link href="${root}/basejs/json/css/base.css" rel="stylesheet">
...
<link href="${root}/basejs/json/css/jquery.numberedtextarea.css" rel="stylesheet">
<script src="${root}/basejs/json/js/hm.js"></script>
<script src="${root}/basejs/json/jq/jquery.min.js"></script>
<script src="${root}/basejs/json/jq/jquery.message.js"></script>
<script src="${root}/basejs/json/jq/jquery.json.js"></script>
<script src="${root}/basejs/json/jq/jquery.xml2json.js"></script>
<script src="${root}/basejs/json/jq/jquery.json2xml.js"></script>
<script src="${root}/basejs/json/js/json2.js"></script>
<script src="${root}/basejs/json/js/jsonlint.js"></script>
<script src="${root}/basejs/json/js/clipboard.min.js"></script>
<script src="${root}/basejs/json/js/FileSaver.min.js"></script>
<script src="${root}/basejs/json/jq/jquery.numberedtextarea.js"></script>
