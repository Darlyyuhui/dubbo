...
<body>
<tags:header/>
<div class="container tag-body" align="center">
    <h1>现场采样页面展示
        <small>主要完成APP端页面展示效果</small>
    </h1>
    <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-6">
            <img style="padding: 4px" src="${sourceUrl}/images/samply/ic_back_title.png"/>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-6">
            <span style="width: 90%">现场采样</span>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-6">
            <span style="padding: 4px">保存</span>
        </div>
    </div>
</div>
<hr>
